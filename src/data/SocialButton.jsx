...
export const CommunityDevButton = props => (
	<NamedIconButton
		...
		icon={<Google />}
		href="https://gdsc.community.dev/sns-college-of-engineering/"
		{...props}
	/>
);
...
export const InstagramButton = props => (
	<NamedIconButton
		...
		icon={<Instagram />}
		href="https://instagram.com/gdscsnsce"
		{...props}
	/>
);
...
export const GitHubButton = props => (
	<NamedIconButton
		...
		icon={<GitHub />}
		href="https://github.com/gdscsnsce"
		{...props}
	/>
);
...
export const LinkedInButton = props => (
	<NamedIconButton
		...
		icon={<LinkedIn />}
		href="https://www.linkedin.com/company/gdsc-sns-college-of-engineering/"
		{...props}
	/>
);
...
export const YouTubeButton = props => (
	<NamedIconButton
		...
		icon={<YouTube />}
		href="https://youtube.com/@gdscsnsce"
		{...props}
	/>
);

export const EmailButton = props => (
	<NamedIconButton title="Email" tooltip="Email us" icon={<Email />} href="mailto:gdscsnscollegeofengineering@gmail.com" {...props} />
);
